import github #Necesita el modulo github, $pip install pygithub
# -*- coding: iso-8859-15
import sys
import codecs
...
if len(sys.argv) == 5:
	...
	slices.write("project, year, totaltickets, opentickets, gcstars, totalrepowrites, watchers, collaborators, size, language\n")
	...
	for i in range(i, j):
		...
		# write stars
		try :
			slices.write(', "' + str(repo.stargazers_count) + '"')
		except :
			slices.write(', "' + str(0) +'"')
		# write commits
		try :
	...
	print ("Uso: $python proyectos.py n0 n1 user passwd")
